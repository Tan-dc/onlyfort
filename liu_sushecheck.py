...
try:
    ...
    #登录账号
    login = {'uname': '3000021004','pd_mm': 'a82a0ab611b2c8f8fa600bcb5f7ec019'}
    ...
    if result["aaData"]:
        ...
        requests.get(f"https://api.day.app/eZahvMLtGr27qT3oTkUCpN/{bhgss}?group=ssbhg&sound=glass")
    else:
        requests.get(f"https://api.day.app/eZahvMLtGr27qT3oTkUCpN/无不合格宿舍?group=ssbhg&sound=glass")
except Exception as e:  # 捕获所有异常
    requests.get("https://api.day.app/eZahvMLtGr27qT3oTkUCpN/查询错误，错误:?group=ssbhg&sound=glass")
    print(e)
